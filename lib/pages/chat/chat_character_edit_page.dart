...
class _MomentsDetailPageState extends State<MomentsDetailPage> {
  ...
  void _showImageSourceActionSheet() => setState(() => _showActionSheet = true);
  void _hideActionSheet() => setState(() => _showActionSheet = false);
  ...
  Future<void> _openCamera() async {
    ...
    await Navigator.push(
        context, MaterialPageRoute(builder: (_) => const CameraCapturePage()));
  }
